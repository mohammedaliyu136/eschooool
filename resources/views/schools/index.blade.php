                        ...
                        <div class="row card-body">
                            <div class="col-12">
                                <div class="alert alert-info" role="alert">
                                    <strong>Important Note:</strong> This is a demo school. Please do not use this school for real registration. This action can only be performed once. 
                                    Click <a href="javascript:void(0);" class="font-weight-bold" id="createDemoSchool">here</a> to create the demo school.
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="p-4 mt-5 mb-4">
                                @if($email_verified == 0)
                                    <div class="alert alert-danger mt-2" role="alert">
                                        <strong>Warning!</strong> Please configure the email settings first to continue with creating the school. 
                                        <b>Click here: </b>
                                        <a href="{{ route('system-settings.email.index') }}" class="font-weight-bold">Email Settings</a>
                                    </div>
                                @endif
                            </div>
